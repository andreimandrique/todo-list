...
function displayTask() {
  ...
  for (let i = 0; i < localStorage.length; i++) {
    ...
    const myDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(taskDate, "PP");
